...
if(NOT "/home/dominic/malpac/catkin_ws/devel/include " STREQUAL " ")
  set(malpac_INCLUDE_DIRS "")
  set(_include_dirs "/home/dominic/malpac/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'malpac' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dominic/malpac/catkin_ws/src/malpac/${idir}'.  Ask the maintainer 'dominic <dominic@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dominic/malpac/catkin_ws/devel/lib;/opt/ros/indigo/lib)
